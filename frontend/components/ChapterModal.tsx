            ...
            <AnimatePresence>
                {isOpen && (
                    <div key="chapter-modal" className={`fixed inset-0 z-50 flex items-center justify-center ${isFullscreen ? 'p-0' : 'p-4 sm:p-6'}`}>
                                                                        ...
                                                                        refRender = (
                                                                            <sup onClick={(e) => { 
                                                                                ...
                                                                                setSelectedReference({
                                                                                    reference_text: refData.reference_text,
                        ...
                        <SanggunianModal 
                            isOpen={refFullscreen}
                            onClose={() => { setRefFullscreen(false); setSelectedSentenceForRef(null); setSelectedReference(null); }}
                            sourceText={chapContentOnRef()?.sentence_text || ""}
                            book={book}
                            chapterNumber={chapterNumber}
                            mode={mode === 'buod' ? 'buod' : 'full'}
